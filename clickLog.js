var holding=new inventorySpace();//tatt
var clickedItem;
var findSth;
...
onmousedown = function(event) {
	...
	if(menuOn==1) {
		...
		if(inventoryOn) {
			...
			//kill slot
			if(killSlot.x-invBlockOffset <= x && x <= killSlot.x+itemSize+invBlockOffset && killSlot.y-invBlockOffset <= y && y <= killSlot.y+itemSize+invBlockOffset) {
