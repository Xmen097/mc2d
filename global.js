...
function update() {
	...
	if(playing==2) {
		for(var a of remotePlayers) {
			...
			context.textAlign = "center";
			a.slot.reRender((a.x-camera.x)/tileMultiplier+35, -15*tileMultiplier+(a.y-camera.y*-1)-(a.y-player.y)/2, true, a.component.texture != "textures/player/playerRight.png");
